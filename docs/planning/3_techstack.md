...
| Item                   | Detail                                                                                                                                                                                                                     |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Applications**       | `bff` — NestJS app under `apps/bff/` that owns all browser-facing HTTP and Clerk webhook HTTP ingress. **`user-service`** — NestJS app under `apps/user-service/` (domain users/entitlements; **TCP-only** for BFF RPC). |
